            ...
            <div className='hidden sm:ml-6 sm:block'>
              <div className='flex space-x-4'>
                ...
                <Link
                  ...
                  className={`rounded-md px-3 py-2 text-sm font-medium ${isActive('/about')
                    ? 'bg-gray-700 text-white'
                    : 'text-gray-300 hover:bg-gray-700 hover:text-white'
                    }`}
                >
                ...
                {token && (
                  <Link
                    ...
                    className={`rounded-md px-3 py-2 text-sm font-medium ${isActive('/favorite-list')
                      ? 'bg-gray-700 text-white'
                      : 'text-gray-300 hover:bg-gray-700 hover:text-white'
                      }`}
                  >
                ...
                {!token && (
                  <Link
                    ...
                    className={`rounded-md px-3 py-2 text-sm font-medium ${isActive('/auth')
                ...
                {token && (
                  <Form action='/logout' method='post'>
                    <button className='bg-blue-600 rounded-md px-3 py-2 text-md font-medium  hover:bg-blue-800'>
                      Logout
                    </button>
                  </Form>
                )}
      ...
      <div className='sm:hidden' id='mobile-menu'>
        <div className='space-y-1 px-2 pb-3 pt-2'>
          ...
          <Link
            to='/about'
            onClick={() => setActiveButton('/about')}
            className={`block rounded-md px-3 py-2 text-base font-medium ${isActive('/about')
              ? 'bg-gray-900 text-white'
              : 'text-gray-300 hover:bg-gray-700 hover:text-white'
              }`}
          >
          ...
          <Link
            to='/favorite-list'
            onClick={() => setActiveButton('/favorite-list')}
            className={`block rounded-md px-3 py-2 text-base font-medium ${isActive('/favorite-list')
              ? 'bg-gray-900 text-white'
              : 'text-gray-300 hover:bg-gray-700 hover:text-white'
              }`}
          >
          ...
          <Link
            to='/contact'
            onClick={() => setActiveButton('/contact')}
            className={`block rounded-md px-3 py-2 text-base font-medium ${isActive('/contact')
              ? 'bg-gray-900 text-white'
              : 'text-gray-300 hover:bg-gray-700 hover:text-white'
              }`}
          >
